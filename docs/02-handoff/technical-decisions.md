...
- Net result: three copies, two failure domains beyond Neon (a second Google account/project relationship, plus a fully separate cloud vendor), one of which is a different vendor entirely, two of which are legally/technically immutable.
