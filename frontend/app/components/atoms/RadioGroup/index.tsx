                            ...
                            <span className={styles.radioCustomIcon}>
                                ...
                                {selectedOption === option && !isDisabled ? (
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="21" viewBox="0 0 20 21" fill="none">
                                        ...
                                        <path d="M15.625 10.5C15.625 13.3004 13.138 15.625 10 15.625C6.86202 15.625 4.375 13.3004 4.375 10.5C4.375 7.69959 6.86202 5.375 10 5.375C13.138 5.375 15.625 7.69959 15.625 10.5Z" fill="#CC3366" stroke="#CC3366" stroke-width="0.75" />
                                    </svg>
                                ) : isDisabled ? (
